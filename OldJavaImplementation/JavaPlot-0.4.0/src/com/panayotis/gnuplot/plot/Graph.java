...
public class Graph extends ArrayList<Plot> {
    ...
    public com.panayotis.gnuplot.PropertiesHolder props = new com.panayotis.gnuplot.PropertiesHolder();
    public com.panayotis.gnuplot.PropertiesHolder unprops =
      new com.panayotis.gnuplot.PropertiesHolder("unset ", System.getProperty("line.separator"));
    ...
    void retrieveData(StringBuffer bf) {
        ...
        props.appendProperties(bf);
        unprops.appendProperties(bf);
